...
const contentItems: ContentItem[] = [
  ...
  { 
    ...
    description: "Journey through the Cat's Eye Nebula as immersive storytelling reveals how this 3,000 light-year distant fossil record captures a dying star's final, beautiful transformation.",
    audioSrc: "/assets/cats_description_audio.mp3",
  ...
  { 
    ...
    description: "Interact with our 3D model of the Cat's Eye Nebula to witness the mesmerizing layers and cosmic architecture of a star's magnificent final chapter.",
    modelSrc: "https://chandra.si.edu/vr/ar/Tours/cats_eye/cats-eye-ar.html-eye-nebula.glb",
    celestialObject: "cats-eye",
    category: "planetary-nebulas",
  ...
  { 
    ...
    description: "Experience the Cat's Eye Nebula translated into sound, where stellar energies and gas formations become an otherworldly symphony of cosmic transitions.",
    audioSrc: "/assets/cats_comp.mp4",
    celestialObject: "cats-eye",
    category: "planetary-nebulas",
  ...
  },
  {
    ...
    description: "A planetary nebula is a phase of stellar evolution that the sun should experience several billion years from now, when it expands to become a red giant.",
  ...
  // Black Holes
  {
    ...
    audioSrc: "/assets/GalacticCenter_VisualDescription.mp3",
  ...
  },
  {
    ...
    audioSrc: "/assets/galactic_all.mp4", // Fixed path structure
    celestialObject: "galactic-center",
    category: "black-holes",
    contentType: "sonification"
  },
  {
    ...
    description: "Explore our Galaxy's center from the black hole's perspective through this 360° visualization of stellar winds and superheated gas",
  ...
  { 
    ...
    description: "Journey through narrated tales of Messier 51, where majestic spiral arms craft new stars from cosmic dust.",
    audioSrc: "/assets/M51_VisualDescription.mp3",
  ...
  { 
    ...
    description: "Experience Messier 51's spiral arms translated into sound, where star formation and galactic rotation create a captivating sonic journey.",
    audioSrc: "/assets/m51_all_feb5.mp4",
    celestialObject: "messier-51",
    category: "galaxies",
    contentType: "sonification"
  },
  {
    ...
    description: "Like our own Milky Way, Messier 51 (the Whirlpool Galaxy) showcases magnificent spiral arms that serve as stellar nurseries, where compressed hydrogen gas transforms into brilliant new star clusters along its grand cosmic staircase structure.",
  ...
  { 
    ...
    description: "Explore the stories of Cassiopeia A where a massive star's violent end 350 years ago scattered cosmic debris across 10 light-years.",
    audioSrc: "/assets/CasA_description_audio.mp3", // Removed space in filename
  ...
  { 
    ...
    description: "Explore the stellar explosion of Cassiopeia A in immersive 3D, walking through the actual remnants of this 340-year-old supernova.",
    modelSrc: "https://chandra.si.edu/vr/casa/",
    celestialObject: "cassiopeia-a",
    category: "supernovas",
    contentType: "3d-models"
  },
  { 
    ...
    description: "Hear Cassiopeia A's stellar elements transform into musical notes, radiating outward from its central neutron star.",
    audioSrc: "/assets/mcasa_all.mp4",
    celestialObject: "cassiopeia-a",
    category: "supernovas",
    contentType: "sonification"
  },
  {
    ...
    description: "This video guides viewers through a stunning 3D visualization of Cassiopeia A, letting you soar through colorful layers of stellar debris while different elements create a cosmic symphony that intensifies as you approach the supernova's heart.",
