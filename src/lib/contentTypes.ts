...
const contentTypes: Record<string, ContentType> = {
  "3d-models": {
    ...
    iconName: "Cube",
    icon: CuboidIcon,
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/3dmodels-casa-2025-astro.jpg", // Add your image path here
  ...
  videos: {
    ...
    iconName: "Video",
    icon: VideoIcon,
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/snr1181.jpg", // Add your image path here
  ...
  sonification: {
    ...
    iconName: "Music",
    icon: MusicIcon,
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/sonify10_wr124.jpg", // Add your image path here
  ...
  stories: {
    ...
    iconName: "BookOpen",
    icon: BookOpenIcon,
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/content-types/stories.jpg", // Add your image path here
  ...
  "black-holes": {
    ...
    iconName: "Star",
    icon: StarIcon,
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/25th_gcenter.jpg", // Add your image path here
  ...
  galaxies: {
    ...
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/sonify9_ngc6872.jpg", // Add your image path here
  ...
  "planetary-nebulas": {
    ...
    iconName: "Atom",
    icon: AtomIcon,
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/30dor.jpg", // Add your image path here
  ...
  supernovas: {
    ...
    iconName: "Sparkles",
    icon: SparklesIcon,
    imageSrc: "https://fwaw7h413ibzbblr.public.blob.vercel-storage.com/assets/25th_g21.jpg", // Add your image path here
